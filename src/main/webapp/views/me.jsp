      ...
      <div class="container">
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
            ...
            <a class="navbar-brand icon-brand fa fa-2x fa-facebook-square" href="/home"></a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <form class="navbar-form navbar-left" ng-submit="findX()"  role="search">
            <div class="form-group">
              <div class="search">
                  <input type="text" class="form-control dropdown-toggle"  data-toggle="dropdown" name="uname" ng-model="find.uname"  ng-keyup="findX(find)" placeholder="Search peoples, places and more"/>
                  <span class="fa fa-search"></span>
                  <ul style="width: 400px;background-color:white;appearance:pull-down-menu;" class="dropdown-menu" ng-repeat="u in results"><div class="well-sm" > 
                          <a href="{{u.username}}"><img src="{{u.dp}}" height="50px" width="50px">{{u.name}}</a></div></ul> 
      ...
      <div class="container">
        ...
        <section class="timeline col-sm-9" >
                ...
                <div class='media'>
                  <div class='media-left'>
                    <a href='/home' class='image-post'>
                        <img src='images/pk.jpg' width=150px  height='160px'>
                    </a>
                  </div>
			...
			<div class="btn-group">
				...
				<div class="col-md-6">
				<div class="form-group">
                                    <select id="privacy" style="width: 100px" name="privacy" class="form-control privacy-dropdown pull-left input-sm">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="#" class="image-post">
                        <img ng-if="x[1] != ''" src="{{x[1]}}" style="width: 50;height: 50" />
                    </a>
                  </div>
                  <div class="media-body">
